...
const StorageManager = {
  ...
  seedData(force) {
    ...
    const users = [
      ...
      { id: 2, email: "teacher@edumanage.com", password: "teacher123", role: "teacher", name: "Rachel Kim", linkedId: 1 },
      { id: 3, email: "student@edumanage.com", password: "student123", role: "student", name: "Lucas Bennett", linkedId: 1 },
    ];

    const teachers = [];
    teachers.push({ id: 1, teacherId: "T-1001", firstName: "Rachel", lastName: "Kim", email: "teacher@edumanage.com", phone: "+1-555-0100", department: departments[0], specialization: specializations[0], status: "active" });
    for (let i = 2; i <= 8; i++) {
      const useRu = i % 3 === 0;
    ...
    const students = [];
    students.push({ id: 1, studentId: "S-2001", firstName: "Lucas", lastName: "Bennett", email: "student@edumanage.com", phone: "+1-555-0200", dob: "2003-04-12", gender: "male", department: departments[0], year: 2, address: "12 Campus Ave", enrollmentDate: "2024-09-01", status: "active" });
    for (let i = 2; i <= 20; i++) {
      const useRu = i % 2 === 0;
